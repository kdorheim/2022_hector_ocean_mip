...
#remotes::install_github('jgcri/hector@4410ccf15d4e3219583f54cbb0a639c9361d593a')
#library(hector)
library(magrittr)
...
run(core, runtodate = 2250)
out1 <- fetchvars(core, dates = 1745:2500, vars = vars)

core <- newcore(here::here("hector_inputs", "rcmip_1pctCO2-cdr.ini"), name = "1pctCO2-cdr")
run(core, runtodate = 2250)
out2 <- fetchvars(core, dates = 1745:2500, vars = vars)

core <- newcore(here::here("hector_inputs", "rcmip_abrupt-4xCO2.ini"), name = "abrupt-4xCO2")
run(core, runtodate = 2250)
out3 <- fetchvars(core, dates = 1745:2500, vars = vars)
